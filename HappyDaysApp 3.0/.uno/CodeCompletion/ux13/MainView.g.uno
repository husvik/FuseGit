...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        public Template(MainView parent, MainView parentInstance): base("leftoverCalcScreen", false)
        {
            __parent = parent;
        ...
        {
            var __self = new global::LeftoverCalcScreen(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "leftoverCalcScreen";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template1: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template1(MainView parent, MainView parentInstance): base("mainScreen", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::HomeScreen(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
    ...
    public partial class Template2: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template2(MainView parent, MainView parentInstance): base("favoriteScreen", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::FavoriteScreen(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "favoriteScreen";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template3: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template3(MainView parent, MainView parentInstance): base("shopListScreen", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::ShopListScreen(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "shopListScreen";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template4: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template4(MainView parent, MainView parentInstance): base("introScreen", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
    ...
    public partial class Template5: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template5(MainView parent, MainView parentInstance): base("recipeScreen", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::RecipeScreen(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "recipeScreen";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template6: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template6(MainView parent, MainView parentInstance): base("leftoverScreen", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::LeftoverScreen(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "leftoverScreen";
    }
    ...
    void InitializeUX()
    {
        ...
        var leftoverCalcScreen = new Template(this, this);
        var mainScreen = new Template1(this, this);
        var favoriteScreen = new Template2(this, this);
        var shopListScreen = new Template3(this, this);
        var introScreen = new Template4(this, this);
        var recipeScreen = new Template5(this, this);
        var leftoverScreen = new Template6(this, this);
        var temp20 = new global::BottomPanelBackgroundColor();
        var temp21 = new global::BottomPanel();
        router.Name = __selector0;
        temp17.LineNumber = 4;
        temp17.FileName = "MainView.ux";
        temp17.File = new global::Uno.UX.BundleFileSource(import("../../../BottomPanel.js"));
        temp18.Background = temp20;
        temp18.Children.Add(temp19);
        temp18.Children.Add(temp21);
        temp19.DefaultPath = "introScreen";
        temp19.Templates.Add(leftoverCalcScreen);
        temp19.Templates.Add(mainScreen);
        temp19.Templates.Add(favoriteScreen);
        temp19.Templates.Add(shopListScreen);
        temp19.Templates.Add(introScreen);
        temp19.Templates.Add(recipeScreen);
        temp19.Templates.Add(leftoverScreen);
