...
public partial class BottomPanelBackgroundColor: Fuse.Drawing.LinearGradient
{
    static BottomPanelBackgroundColor()
    {
    }
    [global::Uno.UX.UXConstructor]
    public BottomPanelBackgroundColor()
    {
        InitializeUX();
    }
    void InitializeUX()
    {
        ...
        temp.Offset = 0f;
        temp.Color = float4(0f, 0.4470588f, 0.3137255f, 1f);
        temp1.Offset = 1f;
